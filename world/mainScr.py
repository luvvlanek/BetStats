...
LEAGUES = [
    {
        ...
        "name": "Liga Mistrzów",
        "flag": "🏆",
        "fixtures_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-mistrzow/mecze/",
        "results_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-mistrzow/wyniki/",
        "standings_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-mistrzow/tabela/"
    },
    {
        "id": "uel",
        "name": "Liga Europy",
        "flag": "🏆",
        "fixtures_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-europejska/mecze/",
        "results_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-europejska/wyniki/",
        "standings_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-europejska/tabela/"
    },
    {
        "id": "uecl",
        "name": "Liga Konferencji",
        "flag": "🏆",
        "fixtures_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-konfetrencji/mecze/",
        "results_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-konfetrencji/wyniki/",
        "standings_url": "https://www.flashscore.pl/pilka-nozna/europa/liga-konfetrencji/tabela/"
    }
]
...
async def scrape_league(browser, league):
    ...
    try:
        ...
        selected = scheduled_matches + live_matches 
        for m in selected:
        ...
        # [3b] Statystyki zakończonych meczów
        ...
        for i, fm in enumerate(finished_to_scrape):
            ...
            fm['match_stats'] = stats if stats else None
